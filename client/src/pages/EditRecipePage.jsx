  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setValue('prep_time_minutes', recipeData.prep_time_minutes);
        setValue('cook_time_minutes', recipeData.cook_time_minutes);
        ...
        const recipeCategoryIds = recipeData.categories?.map(cat => cat.id) || [];
        categoriesData.forEach(category => {
          setValue(`categories.${category.id}`, recipeCategoryIds.includes(category.id));
        });
